...
public enum EChatMessageCode implements IMinecraftMessageCode {
	...
	// Code for command chat
	CHAT__NO_EXISTING_CONFIGURATION(Permission.SENDER), CHAT__CHAT_NOT_REGISTERED(Permission.SENDER), CHAT__PLAYER_NOT_REGISTERED(Permission.SENDER);
